...
- [English Flash Cards Generator Fullstack Architecture Document](#table-of-contents)
  ...
  - [Data Models](./data-models.md)
    ...
    - [FlashCard](./data-models.md#flashcard)
      - [TypeScript Interface](./data-models.md#typescript-interface)
      - [Relationships](./data-models.md#relationships)
    - [GenerationSession](./data-models.md#generationsession)
      - [TypeScript Interface](./data-models.md#typescript-interface)
      - [Relationships](./data-models.md#relationships)
  - [API Specification](./api-specification.md)
    - [REST API Specification](./api-specification.md#rest-api-specification)
  - [Components](./components.md)
    - [CardGenerationService](./components.md#cardgenerationservice)
    - [CardPreviewModal](./components.md#cardpreviewmodal)
    - [AuthenticationProvider](./components.md#authenticationprovider)
    - [CardLibraryManager](./components.md#cardlibrarymanager)
    - [UserPreferencesService](./components.md#userpreferencesservice)
    - [AIContentValidator](./components.md#aicontentvalidator)
    - [FileStorageService](./components.md#filestorageservice)
    - [ErrorHandlingService](./components.md#errorhandlingservice)
  ...
  - [Core Workflows](./core-workflows.md)
    - [Card Generation with Preview Workflow](./core-workflows.md#card-generation-with-preview-workflow)
    - [User Authentication and Preferences Flow](./core-workflows.md#user-authentication-and-preferences-flow)
